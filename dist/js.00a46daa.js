...
var fetchDevice = function fetchDevice() {
  ...
  form.addEventListener('submit', function (event) {
    return add_iframe(event);
  });
  document.querySelector('#device').addEventListener('change', function (event) {
    return changeDevice(event);
  });
};
...
(0, _fetchDevice.default)();
},{"./fetch-device":"js/fetch-device.js"}],"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
